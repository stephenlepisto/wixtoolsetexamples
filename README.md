...
- [The WiX Toolset Examples](#the-wix-toolset-examples)
  - [To Install SimpleApp](#to-install-simpleapp)
  - [To Uninstall SimpleApp](#to-uninstall-simpleapp)
- [The WiX Install Type Templates](#the-wix-install-type-templates)
...
- [Customized Installer](#customized-installer)
  - [ExitDialog Checkbox](#exitdialog-checkbox)
  - [Desktop Shortcut Checkbox](#desktop-shortcut-checkbox)
- [Adding a WiX Install Project From Scratch](#adding-a-wix-install-project-from-scratch)
